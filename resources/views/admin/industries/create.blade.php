<x-app-layout>
    <x-slot name="breadcrumb">
        <a href="{{ route('admin.industries.index') }}">Industries</a> / Create
    </x-slot>

    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-3 lg:px-5">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Tambah Industri Baru</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
